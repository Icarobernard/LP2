    ...
    <body>
                ...
                <nav class="navbar navbar-expand-lg mb-4 top-bar navbar-static-top sps sps--abv">
                    <div class="container">
                        ...
                        <a class="navbar-brand mx-auto" href="#">Gra<span>Luntario</span></a>
                        <div class="collapse navbar-collapse" id="navbarCollapse1">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="PesquisaClienteController">Clientes</a> </li>
                                <li class="nav-item"> <a class="nav-link" href="PesquisaAnuncianteController">Voluntários</a></li>
                                <li class="nav-item"> <a class="nav-link" href="PesquisaTrabalhoController">Trabalhos</a> </li>
                                <li class="nav-item"> <a class="nav-link" href="PesquisaRequisicaoController">Requisicao</a> </li>
                               



                                <li class="nav-item"> <a href="login.jsp" class="btn btn-transparent-white btn-capsul">Login</a> </li>
                            </ul>
                        </div>
                    </div>
                </nav>
